...
/**
 * A parameterized suite of FML-script driven integration tests for the UML modeler.
 *
 * <p>
 ...
 * succeed. What is validated here is the modeler actually RUNNING - an editor instantiated, classes and properties created, a class diagram
 * built - not merely the fact that the three VirtualModels parse and validate, which is what {@link TestUMLModeler} covers.
 *
 * <p>
 ...
 * diagrams {@code UMLClassDiagram} generates land there rather than in {@code src/main/resources}.
 *
 * @see TestUMLModeler
 */
@RunWith(Parameterized.class)
public class UMLModelerAutomatedTests extends FMLScriptParserTestCase {
	...
	public UMLModelerAutomatedTests(Resource fmlResource, String name) throws ParseException, ModelDefinitionException, IOException {
